...
```
$ curl http://localhost:6001/placeholder.txt
...
```
$ curl http://localhost:6001/unauthorized
$ # result -> true
```
...
```
$ curl http://localhost:6001/authorized
...
```
$ # POST /auth/login
$ curl -X POST http://localhost:6001/auth/login -d '{"username": "maria", "password": "123"}' -H "Content-Type: application/json"
...
$ curl http://localhost:6001/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2Vybm..."
$ # result -> {"userId":2}
```
